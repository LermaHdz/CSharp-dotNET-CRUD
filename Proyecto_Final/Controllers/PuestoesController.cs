...
namespace Proyecto_Final.Controllers
{
    public class PuestoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idPuesto,descripcion,salario,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Puesto puesto)
        {
            ...
            ViewBag.idUsuarioCrea = new SelectList(db.Usuario, "idUsuario", "nombreUsuario", puesto.idUsuarioCrea);
            ViewBag.idUsuarioModifica = new SelectList(db.Usuario, "idUsuario", "nombreUsuario", puesto.idUsuarioModifica);
            return View(puesto);
        }
