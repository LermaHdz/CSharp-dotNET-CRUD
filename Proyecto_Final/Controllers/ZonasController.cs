...
namespace Proyecto_Final.Controllers
{
    public class ZonasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idZona,nombre,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Zona zona)
        {
            ...
            ViewBag.idUsuarioCrea = new SelectList(db.Usuario, "idUsuario", "nombreUsuario", zona.idUsuarioCrea);
            ViewBag.idUsuarioModifica = new SelectList(db.Usuario, "idUsuario", "nombreUsuario", zona.idUsuarioModifica);
            return View(zona);
        }
