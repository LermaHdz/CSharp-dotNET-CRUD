...
namespace Proyecto_Final.Controllers
{
    public class TurnoesController : Controller
    {
        ...
        {
            var turno = db.Turno.Include(t => t.Usuario).Include(t => t.Usuario1);
        ...
        public ActionResult Create([Bind(Include = "idTurno,descripcion,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Turno turno)
        {
            ...
            ViewBag.idUsuarioCrea = new SelectList(db.Usuario, "idUsuario", "nombreUsuario", turno.idUsuarioCrea);
            ViewBag.idUsuarioModifica = new SelectList(db.Usuario, "idUsuario", "nombreUsuario", turno.idUsuarioModifica);
            return View(turno);
        }
